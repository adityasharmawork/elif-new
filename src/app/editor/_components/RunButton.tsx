...
function RunButton () {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-primary-600 to-primary-500 rounded-lg opacity-100 transition-opacity group-hover:opacity-90" />
      ...
      <div className="relative flex items-center gap-2">
        {isRunning ? (
          ...
          <div className="relative flex items-center justify-center w-4 h-4">
            <Play className="w-4 h-4 text-white fill-white/20 transition-transform group-hover:scale-110 group-hover:fill-white/30" />
          </div>
